...
type DummyServiceClient interface {
	DummyMethod(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DummyResponse, error)
}
...
func (c *dummyServiceClient) DummyMethod(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DummyResponse, error) {
	out := new(DummyResponse)
	err := c.cc.Invoke(ctx, "/proto.DummyService/DummyMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DummyServiceServer interface {
	DummyMethod(context.Context, *DummyRequest) (*DummyResponse, error)
...
func (UnimplementedDummyServiceServer) DummyMethod(context.Context, *DummyRequest) (*DummyResponse, error) {
...
func _DummyService_DummyMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.DummyService/DummyMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DummyServiceServer).DummyMethod(ctx, req.(*DummyRequest))
	}
